...
const ADMIN_PDF_REPORTS = [
  {
    ...
    filename: "ranking-presenca-completo.pdf",
  ...
  },
  {
    ...
    filename: "top-10-assistencias.pdf",
...
const ADMIN_PDF_GENERATOR_REPORTS = [
  ...
  },
  {
    ...
    description: "Jogadores com mais assistências no histórico completo.",
    filenameBase: "ranking-assistencias",
    metricKey: "totalAssists",
    metricLabel: "Assistências",
    defaultLimit: 10,
    nonZeroOnly: true,
...
function resolveAdminPdfGeneratorSelection(reportKey, limitValue) {
  ...
  return {
    ...
    description: isFull
      ...
      : `${baseReport.description} Recorte com os ${resolvedLimit} primeiros nomes do ranking.`,
